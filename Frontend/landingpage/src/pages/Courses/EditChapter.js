...
function editChapter(data, chapterID){
...
const EditChapter = () => {
    ...
    useEffect(() => {
        ...
        const fetchCourse = async () => {
            setLoading(true);
            try {
                const response = await fetch(`${ChapterURL}${chapterID}/`);
    ...
    const handleSubmit = async (e) => {
        ...
        if (name == '' || description == '' || outcome == '') {
            ...
            const data = await editChapter({ 'name' : name, 'description' : description, 'outcome' : outcome, 'course' : courseID }, chapterID);
            console.log(data);
            setSuccess(true);
        }
    }
            ...
            <div className='add-blog-div'>
                ...
                <section className='add-chapter-block'>
                    <header className='add-blog-header'>
                        <h1 className='add-blog-header-text'>Edit Chapter</h1>
                    </header>
                    ...
                    <form className='add-course-form' onSubmit={handleSubmit}>
                        <div className='add-course-form-wrapper'>
                            <div className='blog-input-wrapper'>
                                ...
                                <input className='form-input-field' type="text" id="name" placeholder="Name" defaultValue={name} onChange={
                            ...
                            <div className='content-input-wrapper'>
                                ...
                                <input className='content-input-field' type="text" id="description" placeholder="Description" defaultValue={description} onChange={
                            ...
                            <div className='content-input-wrapper'>
                                ...
                                <input className='content-input-field' type="text" id="outcome" placeholder="Outcome" defaultValue={outcome} onChange={
                            ...
                            <div className='blog-input-wrapper'>
                                <button className='form-submit-button add-blog-button-margin' type="submit">Update Chapter</button>
                            </div>
